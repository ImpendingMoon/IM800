...
rom_ivt:
    ...
    .DEFD fatal_handler                  ; 0x02: NMI (Memory Parity Error)
    ...
    .DEFD default_service                ; 0xC0: System Services TODO
    .DEFD default_service                ; 0xC1: Disk Services TODO
    .DEFD default_service                ; 0xC2: Port Services TODO
    .DEFD default_service                ; 0xC3: Keyboard Services TODO
    .DEFD default_service                ; 0xC4: Video Services TODO
    .DEFD default_service                ; 0xC5: Time Services TODO
    .DEFD default_service                ; 0xC6: Sound Services TODO
    .DEFD default_service                ; 0xC7: Reserved
    .DEFD default_service                ; 0xC8: Reserved
    .DEFD default_service                ; 0xC9: Reserved
    .DEFD default_service                ; 0xCA: Reserved
    .DEFD default_service                ; 0xCB: Reserved
    .DEFD default_service                ; 0xCC: Reserved
    .DEFD default_service                ; 0xCD: Reserved
    .DEFD default_service                ; 0xCE: Reserved
    .DEFD default_service                ; 0xCF: Reserved
    .DEFD default_service                ; 0xD0: Vendor Extension Services
    .DEFD default_service                ; 0xD1: Vendor Extension Services
    .DEFD default_service                ; 0xD2: Vendor Extension Services
    .DEFD default_service                ; 0xD3: Vendor Extension Services
    .DEFD default_service                ; 0xD4: Vendor Extension Services
    .DEFD default_service                ; 0xD5: Vendor Extension Services
    .DEFD default_service                ; 0xD6: Vendor Extension Services
    .DEFD default_service                ; 0xD7: Vendor Extension Services
    .DEFD default_service                ; 0xD8: Vendor Extension Services
    .DEFD default_service                ; 0xD9: Vendor Extension Services
    .DEFD default_service                ; 0xDA: Vendor Extension Services
    .DEFD default_service                ; 0xDB: Vendor Extension Services
    .DEFD default_service                ; 0xDC: Vendor Extension Services
    .DEFD default_service                ; 0xDD: Vendor Extension Services
    .DEFD default_service                ; 0xDE: Vendor Extension Services
    .DEFD default_service                ; 0xDF: Vendor Extension Services
    .DEFD default_service                ; 0xE0: Reserved
    .DEFD default_service                ; 0xE1: Reserved
    .DEFD default_service                ; 0xE2: Reserved
    .DEFD default_service                ; 0xE3: Reserved
    .DEFD default_service                ; 0xE4: Reserved
    .DEFD default_service                ; 0xE5: Reserved
    .DEFD default_service                ; 0xE6: Reserved
    .DEFD default_service                ; 0xE7: Reserved
    .DEFD default_service                ; 0xE8: Reserved
    .DEFD default_service                ; 0xE9: Reserved
    .DEFD default_service                ; 0xEA: Reserved
    .DEFD default_service                ; 0xEB: Reserved
    .DEFD default_service                ; 0xEC: Reserved
    .DEFD default_service                ; 0xED: Reserved
    .DEFD default_service                ; 0xEE: Reserved
    .DEFD default_service                ; 0xEF: Reserved
    .DEFD default_service                ; 0xF0: OS Services
    .DEFD default_service                ; 0xF1: OS Services
    .DEFD default_service                ; 0xF2: OS Services
    .DEFD default_service                ; 0xF3: OS Services
    .DEFD default_service                ; 0xF4: OS Services
    .DEFD default_service                ; 0xF5: OS Services
    .DEFD default_service                ; 0xF6: OS Services
    .DEFD default_service                ; 0xF7: OS Services
    .DEFD default_service                ; 0xF8: OS Services
    .DEFD default_service                ; 0xF9: OS Services
    .DEFD default_service                ; 0xFA: OS Services
    .DEFD default_service                ; 0xFB: OS Services
    .DEFD default_service                ; 0xFC: OS Services
    .DEFD default_service                ; 0xFD: OS Services
    .DEFD default_service                ; 0xFE: OS Services
    .DEFD default_service                ; 0xFF: OS Services
.size: .EQU $-rom_ivt
